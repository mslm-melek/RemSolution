...
public static class MappingExtensions
{
    ...
    public static Task<List<TDestination>> ProjectToListAsync<TDestination>(this IQueryable queryable, CancellationToken cancellationToken = default) where TDestination : class
