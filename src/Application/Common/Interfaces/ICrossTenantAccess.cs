...
/// and a CrossTenantAccessLog row is persisted before any data is exposed,
/// regardless of whether the surrounding operation completes. Read-only:
/// the scope hands out untracked queries, never write access.
/// </summary>
