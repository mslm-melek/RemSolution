...
namespace RemSolution.Application.Features.Agency.DTOs
{
    public class AgencyDto
    {
        ...
        // A second currency the invoice total is also shown in; null prints
        // nothing. Informational — see AgencySettings.
        ...
        public class Mapping : IRegister
        {
            public void Register(TypeAdapterConfig config)
            {
                config.NewConfig<Domain.Entities.Agency, AgencyDto>()
                    ...
                    .Map(d => d.InvoiceDisplayCurrency,
                         s => s.Settings != null ? s.Settings.InvoiceDisplayCurrency : null);
            }
        }
    }
}
