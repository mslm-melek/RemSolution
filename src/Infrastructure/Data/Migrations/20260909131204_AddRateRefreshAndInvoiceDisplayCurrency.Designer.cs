...
namespace RemSolution.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909131204_AddRateRefreshAndInvoiceDisplayCurrency")]
    partial class AddRateRefreshAndInvoiceDisplayCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.AgencySettings", b =>
                {
                    ...
                    b.Property<int>("ClientDocumentExpiryLeadDays")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InvoiceDisplayCurrency")
                        .HasMaxLength(3)
                        .IsUnicode(false)
                        .HasColumnType("varchar(3)");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.CarUnavailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CarId", "StartDate", "EndDate"), new[] { "Reason", "AgencyId" });

                    b.ToTable("CarUnavailabilities");
                });

            modelBuilder.Entity("RemSolution.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Client", b =>
                {
                    ...
                    b.Property<DateTime?>("CINExpiryDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("CINFileId")
                        .HasColumnType("int");

                    b.Property<int?>("CINPortraitFileId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("PasseportExpiryDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTimeOffset?>("PersonalDataErasedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyId", "RentingId");

                    b.HasIndex("AgencyId", "Year", "SequenceNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.DocumentTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyId", "Kind", "Language");

                    b.ToTable("DocumentTemplates");
                });

            modelBuilder.Entity("RemSolution.Domain.Entities.DocumentTemplateField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyId", "DocumentTemplateId");

                    b.HasIndex("DocumentTemplateId", "Placeholder")
                        .IsUnique();
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Facture", b =>
                {
                    ...
                    b.Property<decimal?>("DisplayExchangeRate")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");

                    b.Property<DateTime?>("DisplayRateAsOf")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.PlanFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Renting", b =>
                {
                    ...
                    b.Property<DateTime?>("DepositSettledAt")
                        .HasColumnType("datetime2");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CarId", "StartDate", "EndDate"), new[] { "RentingState", "AgencyId" });

                    b.ToTable("Rentings");
                });

            modelBuilder.Entity("RemSolution.Domain.Entities.RentingFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasIndex("AgencyId", "Status", "ExpiresAt");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Client", b =>
                {
                    ...
                    b.HasOne("RemSolution.Domain.Entities.StoredFile", "CINPortraitFile")
                        .WithMany()
                        .HasForeignKey("CINPortraitFileId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Contract", b =>
                {
                    ...
                    b.HasOne("RemSolution.Domain.Entities.StoredFile", "DocumentFile")
                        .WithMany()
                        .HasForeignKey("DocumentFileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RemSolution.Domain.Entities.DocumentTemplate", "DocumentTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Expense", b =>
                {
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "PaidAmount", b1 =>
                        {
                            b1.Property<int>("ExpenseId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Facture", b =>
                {
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "ExtraServicesAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");

                            b1.Property<decimal>("Amount")
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("ExtraServicesAmount");
                            ...
                            b1.Property<string>("Currency")
                                ...
                                .IsUnicode(false)
                                .HasColumnType("varchar(3)")
                                .HasColumnName("ExtraServicesAmountCurrency");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "FeesAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("Currency")
                                ...
                                .IsUnicode(false)
                                .HasColumnType("varchar(3)")
                                .HasColumnName("FeesAmountCurrency");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "FiscalStampAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "NetAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "RentalAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("Currency")
                                ...
                                .IsUnicode(false)
                                .HasColumnType("varchar(3)")
                                .HasColumnName("RentalAmountCurrency");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "TotalDue", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("Currency")
                                ...
                                .IsUnicode(false)
                                .HasColumnType("varchar(3)")
                                .HasColumnName("TotalDueCurrency");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "VatAmount", b1 =>
                        {
                            b1.Property<int>("FactureId")
                                .HasColumnType("int");
                    ...
                    b.Navigation("ExtraServicesAmount");

                    b.Navigation("FeesAmount");

                    b.Navigation("FiscalStampAmount");

                    b.Navigation("NetAmount");

                    b.Navigation("RentalAmount");

                    b.Navigation("Renting");

                    b.Navigation("TotalAmount");

                    b.Navigation("TotalDue");
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("RemSolution.Domain.Entities.StoredFile", "ProofFile")
                        .WithMany()
                    ...
                    b.HasOne("RemSolution.Domain.Entities.Payment", "ReversesPayment")
                        .WithMany()
            ...
            modelBuilder.Entity("RemSolution.Domain.Entities.Renting", b =>
                {
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "DepositRetainedAmount", b1 =>
                        {
                            b1.Property<int>("RentingId")
                                .HasColumnType("int");
                            ...
                            b1.Property<decimal>("Amount")
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("DepositRetainedAmount");
                            ...
                            b1.Property<string>("Currency")
                                ...
                                .IsUnicode(false)
                                .HasColumnType("varchar(3)")
                                .HasColumnName("DepositRetainedAmountCurrency");
                    ...
                    b.Navigation("DepositRetainedAmount");
                    ...
                    b.OwnsOne("RemSolution.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
                            ...
                            b1.HasKey("RentingFeeId");

                            b1.ToTable("RentingFees");

                            b1.WithOwner()
                                .HasForeignKey("RentingFeeId");
                        });
